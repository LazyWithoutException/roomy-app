...
prosledi = function () {
    ...
    if (tip !== "" && kvadratura !== "" && cena !== "" &&
        namestenost !== "" && grejanje !== "" && pomocne_zgrade !== "" &&
        uknjizenost !== "" && telefon !== "" && sobe !== "" && sprat !== "" &&
        adresa !== "" && lat !== "" && lng !== "" && opis !== "" && hobi !== "" &&
        osobine !== "" && pol !== "" && zaposlen !== "" && godine !== "" &&
        tip_oglasa !== "") {
